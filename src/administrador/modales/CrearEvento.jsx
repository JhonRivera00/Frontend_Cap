                        ...
                        <div className="modal-body mt-4">
                            <form className="row g-2 needs-validation" onSubmit={handleSubmit}>
                                ...
                                <div className="col-12 mt-0" style={{ padding: "0 50px" }}>
                                    ...
                                    <select className="form-control" id="exampleFormControlSelect1" onChange={(e) => { selectFuncion(e.target.value); }}>
                                ...
                                <div className="col-12 mt-0 mt-4" style={{ padding: "0 50px" }}>
                                    ...
                                    <input type="text" className="form-control" placeholder='Titulo' id="validationCustom01" onChange={(e) => (setEvento(e.target.value))} />
                                </div>
                                <div className="col-12 mt-0 mt-4" id='div-lugar' style={{ padding: "0 50px" }}>
                                    ...
                                    <input type="text" className="form-control" placeholder='Lugar evento' id="validationCustom01" onChange={(e) => (setLugar(e.target.value))} />
                                </div>
                                ...
                                <div className="col-12 mt-4" style={{ padding: "0 50px 0 50px" }}>
                                    ...
                                    <input type="datetime-local" className="form-control" min={fechaInicio} id="validationCustom02" onChange={(e) => setFechaInicial(e.target.value)} />
                                </div>
                                {/* Fecha y hora final */}
                                <div className="col-12 mt-4" style={{ padding: "0 50px 0 50px" }}>
                                    <label htmlFor="validationCustom03" className="form-label">FECHA Y HORA FINAL</label>
                                    <input type="datetime-local" className="form-control" min={fechaInicial} id="validationCustom03" onChange={(e) => setFechaFinal(e.target.value)} />
                                </div>
