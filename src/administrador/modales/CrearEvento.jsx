                        ...
                        <div className="modal-body mt-4">
                            <form className="row g-2 needs-validation" onSubmit={handleSubmit}>
                                ...
                                <div id='div-img' className="col-12 mt-4" style={{ padding: "0 50px 0 50px" }}>
                                    ...
                                    <input type="file" className="form-control" placeholder='Ingresar descripcion' id="validationCustom01" onChange={(e) => setImagenes(e.target.files[0])} />
                                </div>
                                <div id='div-pdf' className="col-12 mt-4" style={{ padding: "0 50px 0 50px" }}>
                                    ...
                                    <input type="file" className="form-control" id="validationCustom01" onChange={(e) => setPdf(e.target.files[0])} />
                                </div>
                                {/* Descripcion */}
                                <div className="col-12 mt-4" style={{ padding: "0 50px 0 50px" }}>
