                                ...
                                <form className="needs-validation contenedor-registro rounded-3 mx-3" onSubmit={handleSubmit} >
                                    <div className="row g-3  text-white  p-4 rounded-3 ">
                                        ...
                                        <div className="col-sm-6">
                                            ...
                                            <input type="text" className="form-control" id="firstName" placeholder="" value={nombres} onChange={(e => setNombre(e.target.value))} />
                                        </div>

                                        <div className="col-sm-6">
                                            <label htmlFor="lastName" className="form-label">Apellidos</label>
                                            <input type="text" className="form-control" id="lastName" placeholder="" value={apellidos} onChange={(e) => setApellidos(e.target.value)} />
                                        </div>
                                        ...
                                        <div className="col-sm-9">
                                            ...
                                            <input type="number" className="form-control" id="lastName" placeholder="" value={numeroDocumento} onChange={(e) => setNumeroDocumento(e.target.value)} />
                                        </div>
                                        ...
                                        <div className="col-12">
                                            ...
                                            <select className="form-select" id="validationGenero" aria-label="Default select example" value={genero} onChange={(e) => { setGenero(e.target.value) }} required>
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="email" className="form-control" id="email" placeholder="" value={correo} onChange={(e) => setCorreo(e.target.value)} />
                                        </div>

                                        <div className="col-12">
                                            <label htmlFor="address1" className="form-label">Contraseña</label>
                                            <input type="password" className="form-control" id="address1" placeholder="" value={contrasenaUno} onChange={(e) => setContrasenaUno(e.target.value)} />
                                        </div>
