                    ...
                    <div id="modal-usuario-registro ">
                        <div className="modal-dialog ">
                            <div className="modal-content  bg-color-blue  text-white ">
                                ...
                                <form className="needs-validation contenedor-registro rounded-3 mx-3" id="formulario" onSubmit={handleSubmit} >
                                    <div className="row g-3  text-white  p-4 rounded-3 ">
                                        ...
                                        <div className="col-sm-6 formulario__grupo" id="grupo_nombres">
                                            ...
                                            <div className="formulario__grupo-input">
                                                <input type="text" className="form-control formulario__input" id="nombres" name="nombre" value={nombres} placeholder="" onChange={(e => setNombre(e.target.value))} />
                                                <i class="formulario_validacion-estado" src={Checkl} ></i>
                                            </div>
                                        ...
                                        <div className="col-sm-6">
                                            ...
                                            <input type="text" name="apellidos" className="form-control" id="lastName" placeholder="" onChange={(e) => setApellidos(e.target.value)} />
                                        </div>
                                        <div className="col-sm-3">
                                            <label htmlFor="validationGenero" className="form-label">Tipo </label>
                                            <select className="form-select" name="tipo" id="Genero" aria-label="Default select example" onChange={(e) => setTipo(e.target.value)} required>
                                        ...
                                        <div className="col-sm-9">
                                            ...
                                            <input type="number" className="form-control" id="lastName" name="numDocumento" placeholder="" onChange={(e) => setNumeroDocumento(e.target.value)} />
                                        </div>
                                        <div className="col-12">
                                            <label htmlFor="lastName" className="form-label">Foto de perfil</label>
                                            <input type="file" className="form-control" id="lastName" name="fotoPerfil" placeholder="" onChange={(e) => setImgAprendiz(e.target.files[0])} />
                                        </div>
                                        <div className="col-12">
                                            <label htmlFor="validationGenero" className="form-label">Genero</label>
                                            <select className="form-select" id="validationGenero" aria-label="Default select example" name="genero" onChange={(e) => { setGenero(e.target.value) }} required>
                                        ...
                                        <div className="col-12">
                                            ...
                                            <select className="form-select" id="validationGenero" name="programa" aria-label="Default select example" onChange={(e) => { setPrograma(e.target.value) }}>
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="Number" className="form-control" id="telefono" placeholder="" name="telefono" onChange={(e) => setNumTelefono(e.target.value)} />
                                        </div>

                                        <div className="col-12">
                                            <label htmlFor="email" className="form-label">Correo</label>
                                            <input type="email" name="correo" className="form-control" id="email" placeholder="" onChange={(e) => setCorreo(e.target.value)} />
                                        </div>
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="password"
                                                name="contrasenaUno"
                                                className="form-control" id="address1" placeholder="" onChange={(e) => {
                                                    setContrasenaUno(e.target.value)
                                                }} />
                                        </div>
                                        ...
                                        <div className="col-12">
                                            ...
                                            <input type="password"
                                                name="cointraseñaDos"
                                                className="form-control" id="address2" placeholder="" onChange={(e) => {
                                                    setContrasenaDos(e.target.value)
                                                }} />
                                        </div>
                                        ...
                                        <div className="w-100 d-flex justify-content-center">
                                            <button className="w-50 btn btn-green" type="submit"

                                                id="botton-registrar">Registrar</button>
                                        </div>
