                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h1 className="modal-title fs-3 w-100 text-center" id="staticBackdropLabel">{datosMotivoNoti.titulo}</h1>
                                ...
                                <div className="modal-footer d-flex align-items-center justify-content-center">
                                    <button type="button" className="btn btn-green border-green col-sm-3" data-bs-dismiss="modal">Cerrar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="modal fade" id="verNotificacion" data-bs-backdrop="static" aria-hidden="true">
                        <div className="modal-dialog">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h1 className="modal-title fs-3 w-100 text-center" id="staticBackdropLabel">{datosMotivoNoti.titulo}</h1>
                                    <button type="button" className="btn-close font-weight-bold" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div className="modal-body w-100 text-center">
            ...
            <>
                <div className="modal fade" id="verNotificacion" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h1 className="modal-title fs-3 w-100 text-center" id="staticBackdropLabel">Motivo Aplazamiento Admin</h1>
                                <button type="button" className="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
